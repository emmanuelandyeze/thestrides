...
import { Flex, Icon, Stack, Divider, Button, Spinner, Text, Box, Image } from '@chakra-ui/react';
import moment from 'moment';
import Link from 'next/link';
import React, { useRef, useState } from 'react';
import { HiOutlineDotsHorizontal } from 'react-icons/hi';
import { RiCakeLine } from 'react-icons/ri';
import { FaImage, FaReddit } from 'react-icons/fa';
...
const About:React.FC<AboutProps> = ({communityData}) => {
    ...
    const setCommunityStateValue =
			useSetRecoilState(communityState);
							...
							>
								...
								{communityData.createdAt && (
									<Text>
										...
										{moment(
											new Date(
												communityData.createdAt.seconds *
													1000,
											),
										).format('MMM DD, YYYY')}
									</Text>
